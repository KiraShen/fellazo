define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'finance/report/monthly/index',
                    add_url: 'finance/report/monthly/add',
                    edit_url: 'finance/report/monthly/edit',
                    del_url: 'finance/report/monthly/del',
                    multi_url: 'finance/report/monthly/multi',
