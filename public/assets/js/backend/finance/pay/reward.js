define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'finance/pay/reward/index',
                    add_url: 'finance/pay/reward/add',
                    edit_url: 'finance/pay/reward/edit',
                    del_url: 'finance/pay/reward/del',
                    multi_url: 'finance/pay/reward/multi',
                    table: 'pay_reward',
                }
            });
