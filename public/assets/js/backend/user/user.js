            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'icnumber', title: __('ICnumber'), operate: 'LIKE'},
                        ...
                        {field: 'bankaccount', title: __('Bankaccount'), operate: 'LIKE',visible: false},
                        {field: 'bankname', title: __('Bankname'), operate: 'LIKE',visible: false},
                        {field: 'bankaddress', title: __('Bankaddress'), operate: 'LIKE',visible: false},
                        ...
                        {field: 'successions', title: __('Successions'), visible: false, operate: 'BETWEEN', sortable: true,visible: false},
